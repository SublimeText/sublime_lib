from typing import Tuple, List, Any, Union, Callable, Optional, TypeVar, Collection
...
class View(object):
    ...
    def add_regions(self, key: str, regions: Collection[Region], scope: str = "", icon: str = "", flags: int = 0) -> None: ...
