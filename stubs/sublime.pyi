...
def run_command(cmd: str, args: dict=None) -> None: ...
...
class Window(object):
    ...
    def run_command(self, cmd: str, args=None) -> None: ...
    ...
    def focus_sheet(self, sheet) -> None: ...
    def focus_view(self, view) -> None: ...
    ...
    def lookup_references_in_index(self, sym: str): ...
    def lookup_references_in_open_files(self, sym: str): ...
...
class View(object):
    ...
    def set_viewport_position(self, xy: vector, animate: bool = True): ...
